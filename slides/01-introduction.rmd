...
- Specifically, we use
    ...
    - `Markdown` to format a piece of text intp a paper,
    - `Git` to keep track of what we have done,
    - `Github` to make our material public and share our ideas.
...
![Research cycle in theory](fig/ResearchCycle.pdf)
...
1.  Go to [https://github.com/join  ](https://github.com/join) and create account
