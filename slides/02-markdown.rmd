---
title: "Markup languages---Power at your fingertips"
...
4. Nowadays:
    ...
    + can be extended with code or---even better---its results
...
- if not already done do: 
  - ```git clone https://github.com/Thdegraaff/ERSA-WooW```

- go to ```/Assignments/Assignment1```

- and transform `DraftPaper.txt` *as much as possible* in `RStudio`
